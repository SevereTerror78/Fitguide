...
class CheckoutControllerTest extends TestCase
{
    ...
    {
        parent::setUp();
        config(['countries' => ['HU' => 'Hungary']]);

        if (!function_exists('shipping_fee')) {
            eval('function shipping_fee($country, $method) { return $method === "pickup" ? 0 : 1500; }');
        }
    }
